...
public final class MySQLStorage extends StorageComponent {
  ...
  public final static class Builder extends StorageComponent.Builder {
  ...
  @Override public SpanStore spanStore() {
    return new MySQLSpanStore(datasource, context, schema(), strictTraceId);
  }

  @Override public SpanConsumer spanConsumer() {
    return new MySQLSpanConsumer(datasource, context, schema());
  }
